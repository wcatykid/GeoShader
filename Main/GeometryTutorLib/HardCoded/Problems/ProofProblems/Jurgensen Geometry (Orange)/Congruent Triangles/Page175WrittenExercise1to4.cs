	...
	public class Page175WrittenExercise1to4 : CongruentTrianglesProblem
	{
        public Page175WrittenExercise1to4(bool onoff, bool complete) : base(onoff, complete)
		{
            ...
            collinear.Add(new Collinear(pts));
                        ...
                        parser = new GeometryTutorLib.TutorParser.HardCodedParserMain(points, collinear, segments, circles, onoff); given.Add(new GeometricCongruentSegments((Segment)parser.Get(new Segment(x, a)), (Segment)parser.Get(new Segment(a, c))));
