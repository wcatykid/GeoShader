...
{
    public class Page7Prob1b : ActualShadedAreaProblem
    {
        public Page7Prob1b(bool onoff, bool complete)
            : base(onoff, complete)
        {
            ...
            wanted.Add(new Point("", 5, 14));
            wanted.Add(new Point("", 3, 16.7));
            goalRegions = parser.implied.GetAtomicRegionsByPoints(wanted);

            SetSolutionArea(9 * System.Math.PI);

            problemName = "McDougall Page 7 Problem 1b";
